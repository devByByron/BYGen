...
const languages = ["javascript", "typescript", "python", "go", "java", "csharp", "rust"] as const;
...
export default function CodePage() {
  ...
  const onDownload = () => {
    ...
    a.href = url; a.download = `bygen-snippet.${ext}`; a.click();
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Generate code snippets in multiple languages with BYGen." />
      ...
      <main className="max-w-6xl mx-auto px-4 py-8 space-y-8">
        ...
        {output && (
          <section className="space-y-4 animate-fade-in">
            <Card className="glass-panel">
              <CardHeader>
                <CardTitle className="font-mono">Output</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="rounded-md overflow-hidden border">
                  <SyntaxHighlighter language={language as any} style={vscDarkPlus} customStyle={{ margin: 0, background: "transparent" }}>
                    {output}
                  </SyntaxHighlighter>
                </div>

...
export default function TextPage() {
  ...
  const onDownload = () => {
    ...
    a.href = url; a.download = "bygen-text.txt"; a.click();
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        ...
        <meta name="description" content="Generate high-quality text from prompts with BYGen." />
        ...
        {output && (
          <section className="space-y-4 animate-fade-in">
            <Card className="glass-panel">
              ...
              <CardContent className="space-y-4">
                <div className="whitespace-pre-wrap text-left">{output}</div>
